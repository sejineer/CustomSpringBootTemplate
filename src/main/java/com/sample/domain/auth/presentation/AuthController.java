...
import com.sample.global.config.security.token.CurrentUser;
import com.sample.global.config.security.token.UserPrincipal;
import com.sample.domain.user.domain.User;
import com.sample.global.payload.Message;
import com.sample.domain.auth.application.AuthService;
